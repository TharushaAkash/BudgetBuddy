...
class AppTranslations {
  static const Map<String, Map<String, String>> translations = {
    'en': {
      ...
      'ai_language_sub': 'English / සිංහල',
      'use_ai_scanner': 'Use AI for Scanner',
      'use_ai_scanner_sub': 'Use Groq Vision API (Internet required)',
    ...
    'si': {
      ...
      'ai_language': 'AI භාෂාව',
      'ai_language_sub': 'සිංහල / English',
      'use_ai_scanner': 'බිල් ස්කෑන් කිරීමට AI භාවිතා කරන්න',
      'use_ai_scanner_sub': 'Groq Vision API භාවිතා කරන්න (Internet අවශ්‍යයි)',
